...
public class Results 
{
	...
	private void markingSchemeSetup()
	{
		...
		maxGrade = Input.getUserNumericInput(offset, HighestPossible);
		
		System.out.println("Please enter the minimum marking grade");
		minGrade = Input.getUserNumericInput(0, maxGrade - offset);
		
		System.out.println("Please enter the passing grade");
		passingGrade = Input.getUserNumericInput(minGrade, maxGrade);
	}
	...
	private void outputMarksInfo()
	{
		...
		per = total * (100/(float)(maxGrade*3));
